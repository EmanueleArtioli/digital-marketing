...
df_2_dist_emailprovider %>% summary()
...
df_2_dist_typjob %>% summary()

### Variable TYP_CLI_ACCOUNT ###

df_2_dist_typacc <- df_2_cli_account_clean %>%
...
#already done, the previous TO-DO called for an inexistent df
